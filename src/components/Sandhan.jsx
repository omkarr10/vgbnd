    ...
    <div className="container-xxl bg-white p-0">
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <h1 className="mb-4">Sandhan Valley Trek</h1>
              <p className="mb-4">
                Nestled deep in the Sahyadris, Sandhan is Maharashtra’s answer to the Grand Canyon. Adventure begins where light fades—
                with rappelling, water crossings, and raw terrain, culminating in nights under stars.
                <br /><br />
                <strong>Nearby Attractions:</strong> Ratangad Fort, Bhandardara Dam, Amruteshwar Temple.
                <br /><br />
                <strong>How to Reach:</strong><br />
                - <strong>From Mumbai/Pune:</strong> Train to Igatpuri → local jeep to Samrad village.
              </p>
                  ...
                  <div className="col-sm-4" key={i}>
                    <div className="border rounded p-1">
                      <div className="border rounded text-center p-4">
                        ...
                        <h2 className="mb-1"><CountUp end={50 + i * 25} duration={2} /></h2>
            ...
            <div className="col-lg-6">
              <div className="row g-3">
                {["sn3.jpg", "sn2.jpg", "sn4.jpg", "sn6.jpg"].map((img, i) => (
                  <div className={`col-6 text-${i % 2 === 0 ? "end" : "start"}`} key={img}>
                    <motion.img
                      ...
                      alt={`sandhan-${i}`}
                      onClick={() => openModal(`/treks/sandhan/${img}`)}
        ...
        <div className="row g-0">
          <div className="col-md-6 bg-dark d-flex align-items-center">
            <div className="p-5">
              ...
              <h1 className="text-white mb-4">Descend into the Valley of Shadows</h1>
              <p className="text-white mb-4">
                Navigate narrow gorges, rappel down rock faces, and embrace the rawness of the Sahyadris. No filters. Just nature.
              </p>
              <Link to="/BookNow" state={{ location: "Sandhan Valley Trek" }} className="btn btn-light py-md-3 px-md-5">Book Your Tent</Link>
            </div>
          </div>
          <div className="col-md-6">
            <iframe
              ...
              referrerPolicy="no-referrer-when-downgrade" title="Sandhan Valley Map"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="container-xxl py-5">
        <div className="container text-center">
          ...
          <h1 className="mb-5">Experience the <span className="text-primary">Essence of Sandhan</span></h1>
