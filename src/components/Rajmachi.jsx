      ...
      <div className="container-fluid p-0 mb-5">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img className="w-100" src="/treks/harishchandragad/hr8.jpg" alt="Alibaug" />
              ...
              <div className="row g-3">
                <div className="col-6 text-end">
                  <motion.img
                    ...
                    src="/treks/harishchandragad/hr3.png"
                    alt="about-1"
                    style={{ marginTop: "25%" }}
                ...
                <div className="col-6 text-start">
                  <motion.img
                    ...
                    src="/treks/harishchandragad/hr6.jpg"
                    alt="about-2"
                    initial={{ opacity: 0, scale: 0.8 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                ...
                <div className="col-6 text-end">
                  <motion.img
                    ...
                    src="/treks/harishchandragad/hr7.jpg"
                    alt="about-3"
                    initial={{ opacity: 0, scale: 0.8 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                ...
                <div className="col-6 text-start">
                  <motion.img
                    className="img-fluid rounded w-75"
                    src="/treks/harishchandragad/hr9.jpg"
                    alt="about-4"
                    initial={{ opacity: 0, scale: 0.8 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
