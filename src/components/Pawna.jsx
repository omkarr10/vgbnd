    ...
    <div className="container-xxl bg-white p-0" ref={topRef}>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <p className="mb-4">
                Pawna Lake is one of the most serene weekend destinations near Lonavala. Camp by the picturesque lake, enjoy bonfires under the stars, live acoustic music, stargazing, BBQs, and adventure games. Surrounded by scenic hills and forts like Tikona and Lohagad, it's a perfect escape for peace lovers and thrill-seekers alike.
                <br /><br />
                  ...
                  <div className="col-sm-4" key={i}>
                    <div className="border rounded p-1">
                      <div className="border rounded text-center p-4">
                        ...
                        <h2 className="mb-1"><CountUp end={300 + i * 50} duration={2} /></h2>
      ...
      <section className="container-xxl py-5 px-0">
        <div className="row g-0">
          <div className="col-md-6 bg-dark d-flex align-items-center">
            <div className="p-5">
              <h6 className="section-title text-white text-uppercase mb-3">Lakeside Camping</h6>
              <h1 className="text-white mb-4">Reconnect with Nature at Pawna</h1>
              <p className="text-white mb-4">
                Let go of the digital world and immerse yourself in calm waters, breezy evenings, and laughter-filled nights at Pawna.
              </p>
      ...
      <section className="container-xxl py-5">
        <div className="container text-center">
          ...
          <h1 className="mb-5">Why Choose <span className="text-primary">Pawna</span> Camping?</h1>
          <div className="row g-4">
            {[
              { icon: FaUtensils, title: "BBQ & Meals" },
              { icon: FaGlassCheers, title: "Bonfire & Music" },
              { icon: FaSwimmer, title: "Lake Activities" },
              { icon: FaHotel, title: "Tent Stay" },
              { icon: FaUsers, title: "Group Fun" },
              { icon: FaSpa, title: "Chill Vibes" },
            ].map((s, i) => (
              <motion.div
