        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <p className="mb-4">
                Nestled in the Sahyadris, Lonavala offers a lush, peaceful camping escape. Experience rappelling, forest hikes, BBQs, and cozy tent nights under the stars.
                <br /><br />
                <strong>Nearby Attractions:</strong> Tiger’s Point, Rajmachi Fort, Bhushi Dam, and Lonavala Lake.
                <br /><br />
                <strong>How to Reach:</strong><br />
                From Mumbai/Pune: Take a train or bus to Lonavala. Pickup from the station can be arranged.
              </p>
                  ...
                  <div className="col-sm-4" key={i}>
                    <div className="border rounded p-1">
                      <div className="border rounded text-center p-4">
                        ...
                        <h2 className="mb-1">
                          <CountUp end={[50, 20, 100][i]} duration={2} />
                        </h2>
          ...
          <div className="col-md-6 bg-dark d-flex align-items-center">
            <div className="p-5">
              ...
              <p className="text-white mb-4">
                Connect with nature, hike hidden trails, and bond over bonfires in our forest-side camping experience.
              </p>
              <Link to="/BookNow" state={{ location: "Lonavala Jungle Camping" }} className="btn btn-light py-md-3 px-md-5">Book Your Tent</Link>
            </div>
          </div>
