        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <p className="mb-4">
                Vasota Fort, nestled in the dense Koyna Wildlife Sanctuary near Bamnoli, offers one of Maharashtra’s most scenic jungle treks. Surrounded by the Shivsagar Lake and thick forests, the fort remains untouched and wild. It’s an ideal destination for nature enthusiasts and those looking to explore a less-commercial route. A boat ride across the lake and the jungle trail leading to the fort makes this trek unique and memorable.
                <br /><br />
        ...
        <div className="row g-0">
          <div className="col-md-6 bg-dark d-flex align-items-center">
            <div className="p-5">
              ...
              <p className="text-white mb-4">
                Dive into the wild on the Vasota Fort trek, where you navigate forest trails, encounter wildlife, and reach a fort steeped in Maratha history — all wrapped in an unforgettable natural landscape.
              </p>
          ...
          <div className="col-md-6">
            <iframe
              ...
              title="Vasota Fort Jungle Trek Map"
            />
          </div>
        </div>
      </section>
        ...
        <div className="container text-center">
          ...
          <div className="row g-4">
            {[
              ...
              { icon: FaGlassCheers, title: "Bonfire Evenings" },
              { icon: FaSwimmer, title: "Lake Boat Ride" },
              { icon: FaHotel, title: "Tent Accommodation" },
              { icon: FaUsers, title: "Guided Groups" },
              { icon: FaSpa, title: "Forest Rejuvenation" },
            ].map((s, i) => (
              <motion.div
