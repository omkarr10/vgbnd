...
import { FaCampground, FaHiking, FaWater, FaUtensils, FaUsers, FaMapMarkedAlt, FaArrowUp } from "react-icons/fa";
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <p className="mb-4">
                Located deep within the forest near Bhira village, Devkund is a hidden gem in Maharashtra. This 1-day trek is ideal for nature lovers and adventure seekers, featuring lush trails, river crossings, and a spectacular plunge waterfall nestled in the Sahyadri ranges.
              </p>
              <p className="mb-4">
                <strong>How to Reach:</strong> Drive or take a bus to Bhira village from Pune or Mumbai. Parking is available. From Bhira, the trek is approximately 3-4 hours round trip.
              </p>
                  ...
                  <div className="col-sm-4" key={i}>
                    <div className="border rounded p-1">
                      <div className="border rounded text-center p-4">
                        ...
                        <h2 className="mb-1"><CountUp end={i === 0 ? 50 : i === 1 ? 1 : 200} duration={2} /></h2>
        ...
        <div className="row g-0">
          <div className="col-md-6 bg-dark d-flex align-items-center">
            <div className="p-5">
              ...
              <h1 className="text-white mb-4">Discover Devkund’s Hidden Waterfall</h1>
              <p className="text-white mb-4">
                Unplug from the chaos and reconnect with nature. Trek through serene forest paths, enjoy riverside breaks, and witness the magic of Devkund’s bluish-green plunge pool.
              </p>
        ...
        <div className="container text-center">
          ...
          <div className="row g-4">
            {[
              ...
              { icon: FaHiking, title: "Trekking Gear (on rent)" },
